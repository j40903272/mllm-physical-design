...
design_ids = ["1904-RISCY-a-3-c20-u0.7-m2-p1-f1.npy", "295-RISCY-a-1-c5-u0.75-m2-p8-f0.npy", "273-RISCY-a-1-c5-u0.7-m4-p2-f0.npy", "1218-RISCY-a-2-c20-u0.7-m3-p8-f0.npy", "1249-RISCY-a-2-c20-u0.8-m2-p3-f0.npy", "1720-RISCY-a-3-c5-u0.7-m2-p4-f1.npy", "1450-RISCY-a-3-c2-u0.8-m3-p3-f0.npy"]
...
for design_id in design_ids:
    ...
    gpdl_output_image = std(gpdl_output_image)
    gpdl_output_image = np.uint8(gpdl_output_image * 255)
    gpdl_output_image = np.clip(gpdl_output_image, 0, 255)
    ...
    fig = sns.heatmap(data=output_image, cmap="rainbow", xticklabels=False, yticklabels=False).get_figure()
    fig.savefig(f"/home/felixchaotw/mllm-physical-design/armo/qualitive_anaylsis/{design_id}_ours.png", dpi=300)
    plt.close()

    fig = sns.heatmap(data=gpdl_output_image, cmap="rainbow", xticklabels=False, yticklabels=False).get_figure()
    fig.savefig(f"/home/felixchaotw/mllm-physical-design/armo/qualitive_anaylsis/{design_id}_gpdl.png", dpi=300)
    plt.close()

    label_image = std(label_image)
    label_image = np.uint8(label_image * 255)
    label_image = np.clip(label_image, 0, 255)

    fig = sns.heatmap(data=label_image, cmap="rainbow", xticklabels=False, yticklabels=False).get_figure()
    fig.savefig(f"/home/felixchaotw/mllm-physical-design/armo/qualitive_anaylsis/{design_id}_label.png", dpi=300)
    plt.close()
