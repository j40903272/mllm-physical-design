...
args.regression_layer_path = f"/home/felixchaotw/mllm-physical-design/armo/regression_weights/minicpm_ArmoRM-Multi-Objective-Data-v0.1_log.pt"
...
for step in tqdm(range(args.n_steps)):
    ...
    if step % 100 == 0:
        ...
        if results["SRCC"].statistic > max_acc:
            ...
            save_path = f"/home/felixchaotw/mllm-physical-design/armo/gating_weights/config_gating_network_{args.model_name}_log.pt"
