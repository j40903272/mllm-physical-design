...
parser.add_argument(
    "--embeddings_dir",
    type=str,
    default="/home/felixchaotw/mllm-physical-design/armo/dataset/train_log.safetensors",
...
parser.add_argument(
    "--output_dir",
    type=str,
    default="/home/felixchaotw/mllm-physical-design/armo/regression_weights/",
...
embedding_files = sorted(glob(f"{embeddings_path}"))
...
save_path = os.path.join(save_dir, f"{args.model_name}_{args.dataset_name}_mixed.pt")
