...
parser.add_argument("--dataset", type=str, default="/home/felixchaotw/mllm-physical-design/armo/dataset/new_train_feature_desc.csv")
...
for epoch in tqdm(range(num_epochs), desc="Training Epochs"):
    ...
    model.eval()
    torch.save(model.state_dict(), f"/data1/felixchao/output/checkpoint-gnn-{epoch}.pth")
    print("Model saved")
