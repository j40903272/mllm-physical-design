...
parser.add_argument("--regression_layer_path", type=str, default="/home/felixchaotw/mllm-physical-design/armo/regression_weights/minicpm_ArmoRM-Multi-Objective-Data-v0.1_mixed.pt")
parser.add_argument("--gating_network_path", type=str, default="/home/felixchaotw/mllm-physical-design/armo/gating_weights/config_gating_network_minicpm_mixed.pt")
parser.add_argument("--dataset", type=str, default="/home/felixchaotw/mllm-physical-design/armo/dataset/test_df_b.csv")
...
train_df.to_csv("/home/felixchaotw/mllm-physical-design/armo/dataset/test_feature_desc_mixed_b.csv", index=False)
