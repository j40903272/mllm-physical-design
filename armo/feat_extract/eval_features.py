...
def evaluate_design(df, save_path, baseline=False, design_name="zero-riscy-a"):
    ...
    if baseline:
        ...
        plt.legend(["Prediction", "Baseline", "Ground Truth"])
...
def main():
    ...
    parser.add_argument("--pretrained", type=str, default="/home/felixchaotw/CircuitNet/model/congestion.pth")
    parser.add_argument("--feature_path", type=str, default="/data2/NVIDIA/CircuitNet-N28/Dataset/congestion/feature/")
    parser.add_argument("--label_path", type=str, default="/data2/NVIDIA/CircuitNet-N28/Dataset/logs/")
