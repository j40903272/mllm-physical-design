...
parser.add_argument("--decoder_path", type=str, default="/data1/felixchao/output/checkpoint-1-mixed.pth")
...
testing_set = ["/home/felixchaotw/mllm-physical-design/armo/dataset/test_feature_desc_mixed_a.csv", "/home/felixchaotw/mllm-physical-design/armo/dataset/test_feature_desc_mixed_b.csv"]
...
if args.baseline == "pretrained":
    ...
    for i, example in tqdm(testing_data.iterrows(), desc="Pretrained"):
        ...
        with torch.no_grad():
            ...
            metric += ssim.item()
            img1 = output_image.squeeze().cpu().numpy()
